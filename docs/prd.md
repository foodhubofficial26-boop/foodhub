...
A complete food ordering platform similar to Swiggy/Zomato, featuring separate client-side and admin-side interfaces. The system enables users to browse restaurants, order food, track deliveries, and manage their profiles, while administrators can manage food items, categories, orders, and users.
...
- Data models: User, FoodItem, Category, Order, Restaurant (optional)
